...
CREATE TABLE `members_caffeine` (
  ...
  `gender` enum('남자','여자') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `members_caffeine` VALUES (10,'2004-12-07',100.0,'남자',0,600,'2025-11-24 11:27:20');
